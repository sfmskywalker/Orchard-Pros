...
namespace Orchard.Messaging.Tests {
    ...
    public class MessageQueueProcessorTests : DatabaseEnabledTestsBase {
        ...
        public override void Register(ContainerBuilder builder) {
            ...
            messageManagerMock
                .Setup(x => x.Send(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), null, null, null, null))
        ...
        private QueuedMessage CreateMessage(string subject) {
            return new QueuedMessage(new QueuedMessageRecord {Id = 1, Subject = subject}) {
