...
namespace OrchardPros.Careers.Controllers {
    ...
    public class PositionController : Controller {
        ...
        public ActionResult Edit(int id) {
            ...
            var profile = _contentManager.Get<ProfessionalProfilePart>(position.ProfileId);
        ...
        private PositionViewModel CreateViewModel(ProfessionalProfilePart profile, Action<PositionViewModel> initialize = null) {
            return InitializeViewModel(new PositionViewModel(), profile, initialize);
        }

        private PositionViewModel InitializeViewModel(PositionViewModel viewModel, ProfessionalProfilePart profile, Action<PositionViewModel> initialize = null) {
