...
namespace OrchardPros.Careers.Controllers {
    ...
    public class ExperienceController : Controller {
        ...
        private ExperienceViewModel CreateViewModel(ProfessionalProfilePart profile, Action<ExperienceViewModel> initialize = null) {
            return InitializeViewModel(new ExperienceViewModel(), profile, initialize);
        }

        private ExperienceViewModel InitializeViewModel(ExperienceViewModel viewModel, ProfessionalProfilePart profile, Action<ExperienceViewModel> initialize = null) {
