(function ($) {
    ...
    var FileUploadViewModel = function (currentFiles) {
        ...
        if (currentFiles) {
            $.each(currentFiles, function () {
                ...
                var transfer = new FileTransfer(fileName, fileSize);

                transfer.label(fileName);
    ...
    $(function () {
        ...
        var currentFiles = fileUpload.data("attachments");
        var viewModel = new FileUploadViewModel(currentFiles);
